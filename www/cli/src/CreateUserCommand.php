...
{
    public static $defaultName = 'api:create-user';

    protected static $defaultDescription = './console.php api:create-user [name] [email] ';
    ...
    {
        try {
            $response = $this->apiClient->post('/api/' . $this->apiVersion . '/user/' . 'create', [
